...
# print(part_3('chien le chat maison voiture message arbre secret soleil fleurs musique rive montagne est ordinateur plage le cell lune livre mer secret ceci restaurant amis le voyage chanson bateau hiver automne neige amour sport bonheur le art danse message avion jardin livre parc est cadeau table chapeau porte lunettes secret chemin message commande fort pont or argent fourchette message couteau tasse montre chapeau guitare le piano balance le nuage parapluie est balle chocolat ceci message chaussettes radio silence plume pinceau secret tableau nuage le bougie chemin miroir porte montre papier le lampe sac message bonjour le sable')) 
